...
object DurationAsLongSerializer : KSerializer<Duration> {
  override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor(javaClass.name, LONG)
  override fun serialize(encoder: Encoder, value: Duration) =
      encoder.encodeLong(value.toLong(MILLISECONDS))
  override fun deserialize(decoder: Decoder): Duration =
      decoder.decodeLong().toDuration(MILLISECONDS)
}
