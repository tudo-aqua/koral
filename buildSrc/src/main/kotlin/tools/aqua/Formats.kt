 ...
 */
fun FreshMarkExtension.defaultFormat(rootProject: Project) {
  licenseHeaderFile(rootProject.file("contrib/license-header.template.md"), "---").also {
 ...
 * @param rootProject the root project; used to look up the license header.
 */
fun JavaExtension.defaultFormat(rootProject: Project) {
  licenseHeaderFile(rootProject.file("contrib/license-header.template.java")).also {
    it.updateYearWithLatest(true)
  }
  googleJavaFormat()
}
 ...
 * @param rootProject the root project; used to look up the license header.
 */
fun FormatExtension.defaultXmlFormat(rootProject: Project) {
  licenseHeaderFile(rootProject.file("contrib/license-header.template.xml"), "<[^?]").also {
    it.updateYearWithLatest(true)
  }
}
